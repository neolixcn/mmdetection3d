...
from tools.data_converter import neolix_converter as neolix
...
def neolix_data_prep(root_path, info_prefix, version, out_dir):
    """Prepare data related to Neolix dataset.
    ...
    Args:
        ...
        out_dir (str): Output directory of the groundtruth database info.
    """
    neolix.create_neolix_info_file(root_path, info_prefix)
    neolix.create_reduced_point_cloud(root_path, info_prefix)
    create_groundtruth_database(
        'NeolixDataset',
        root_path,
        info_prefix,
